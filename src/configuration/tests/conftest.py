"""Shared pytest fixtures for the configuration test suite.
...
provided for tests that construct Qt widgets.
"""
import os
import sys
...
# Make the eSim 'src' tree importable (configuration, maker, …) regardless of
