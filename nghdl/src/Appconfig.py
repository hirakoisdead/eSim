...
class Appconfig:
    ...
    kicad_sym_template = {
        ...
        "U_field": "(property \"Reference\" \"U\" (id 0) (at 6 7 0)" +
                   "(effects (font (size 1.524 1.524))))",
        "comp_name_field": "(property \"Value\" \"comp_name\" (id 1) " +
                           "(at 8 10 0)(effects (font (size 1.524 1.524))))",
        "blank_field": [
        ...
        "draw_pos": "(symbol \"comp_name\"(rectangle (start 0 0 ) " +
                    "(end 15.25 2 )(stroke (width 0) (type default) " +
                    "(color 0 0 0 0))(fill (type none))))",
        "start_draw": "(symbol",
        "input_port": "(pin input line(at -5.15 0.54 0 )(length 5.08 )" +
                      "(name \"in\" (effects(font(size 1.27 1.27))))" +
                      "(number \"1\" (effects (font (size 1.27 1.27)))))",
        "output_port": "(pin output line(at 20.38 0.54 180 )(length 5.08 )" +
